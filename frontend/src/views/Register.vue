          ...
          <div class="card shadow-lg border-0">
            <div class="card-body p-5">
              ...
              <div class="text-center mb-4">
                ...
                <p class="text-muted">
                  Tạo tài khoản độc giả hoặc nhân viên mới
                </p>
              </div>
              ...
              <div class="mb-4 d-flex justify-content-center gap-3">
                <button
                  ...
                  :class="{ active: registerType === 'reader' }"
                ...
                <button
                  ...
                  :class="{ active: registerType === 'staff' }"
              ...
              <form @submit.prevent="handleRegister">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                      ...
                      <small class="text-muted"
                        >Mã độc giả sẽ được tự động tạo khi đăng ký</small
                      >
                    </div>
                  </div>
                </div>
                ...
                <div v-if="registerType === 'staff'">
                  <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                      ...
                      <small class="text-muted"
                        >Mã nhân viên sẽ được tự động tạo khi đăng ký</small
                      >
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div v-if="registerType === 'staff'" class="col-md-12 mb-3">
                    <label for="fullName" class="form-label"
                      >Họ tên đầy đủ <span class="text-danger">*</span></label
                    >
                    <div class="input-group">
                      <span class="input-group-text">
                        <i class="fas fa-user"></i>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-3">
                    <label
                      v-if="registerType === 'reader'"
                      for="phai"
                      class="form-label"
                      >Giới tính <span class="text-danger">*</span></label
                    >
                    <label
                      v-if="registerType === 'staff'"
                      for="chucVu"
                      class="form-label"
